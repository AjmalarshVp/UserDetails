          ...
          ListView(
              ...
              children: [
                ...
                Column(
                  ...
                  kheight30,
                   StudentDetails(str: 'Nomber:'.toUpperCase(), main: studentList[index].age.toUpperCase()),
                   kheight30,
                    StudentDetails(str:'Adress '.toUpperCase(), main: studentList[index].Place.toUpperCase()),
                    kheight30,
                     StudentDetails(str: 'Gmail :'.toUpperCase(), main: studentList[index].batch.toUpperCase()),
