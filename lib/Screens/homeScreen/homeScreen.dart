...
class MyHomePage extends StatelessWidget {
        ...
        body: Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              kHeight20,
              studentTextFeild('Name', StudentNameController),
              kHeight20,
              studentTextFeild('Phone number', StudentAgeController),
              kHeight20,
              studentTextFeild('Gmail', StudentBatchController),
              kHeight20,
              studentTextFeild('Adress', StudentPlaceController),
              kHeight20,
              kHeight30,
  ...
  Future<void> _onAddStudentBtnclicked(BuildContext context) async {
    ...
    if (_name.isEmpty || _age.isEmpty || _batch.isEmpty || _place.isEmpty||_image==null) {
